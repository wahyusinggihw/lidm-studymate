...
class Q3State extends State<Q3> {
  ...
  Widget build(BuildContext context) {
    ...
    Stream<QuerySnapshot> _q3Stream = quadModel.streamList('q3');
    // Stream preview di limit 3 docs saja
    Stream<QuerySnapshot> _q3StreamPreview = quadModel.streamPreview('q3');
