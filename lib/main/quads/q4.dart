...
class Q4State extends State<Q4> {
  ...
  Widget build(BuildContext context) {
    ...
    Stream<QuerySnapshot> _q4Stream = quadModel.streamList('q4');
    // Stream preview di limit 3 docs saja
    Stream<QuerySnapshot> _q4StreamPreview = quadModel.streamPreview('q4');
